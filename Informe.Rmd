...
Se puede observar que el modelo que mejor resultados ofrece es *rf.model30MZ*, que a su vez es el que mejor resultados da en kaggle. También se puede ver que si quitamos una variable más los resultados obtenidos empeoran.
